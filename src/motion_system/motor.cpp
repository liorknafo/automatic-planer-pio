...
Motor::Motor(gpio_num_t in1, ledc_channel_t in1_channel, gpio_num_t in2, ledc_channel_t in2_channel) : in1(in1), in1_channel(in1_channel), in2(in2), in2_channel(in2_channel)
{
}
